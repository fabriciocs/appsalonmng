...
class LoginScreen extends StatelessWidget {
  LoginScreen({Key? key}) : super(key: SalonmngAppKeys.mainScreen);
    ...
    return BlocListener<LoginBloc, LoginState>(
      listener: (context, state) {
        if(state.status.isSubmissionSuccess){
          Navigator.pushNamed(context, SalonmngAppRoutes.main);
        }
      },
      child: Scaffold(
          appBar: AppBar(
            automaticallyImplyLeading: false,
            title:Text('Welcome to salonmngApp'),
          ),
  ...
  Widget register(BuildContext context) {
    return ElevatedButton(
      ...
      onPressed: () => Navigator.pushNamed(context, SalonmngAppRoutes.register),
    );
  }
