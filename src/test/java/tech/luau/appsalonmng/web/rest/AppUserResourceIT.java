...
import tech.luau.appsalonmng.repository.AppUserRepository;
import tech.luau.appsalonmng.service.dto.AppUserDTO;
import tech.luau.appsalonmng.service.mapper.AppUserMapper;
...
class AppUserResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "Rv}@\"ze.D;";
    private static final String UPDATED_EMAIL = "qa}!7f@&.'bH";
    ...
    public static AppUser createEntity(EntityManager em) {
        AppUser appUser = new AppUser().username(DEFAULT_USERNAME).password(DEFAULT_PASSWORD).email(DEFAULT_EMAIL).role(DEFAULT_ROLE);
        return appUser;
    }
    ...
    public static AppUser createUpdatedEntity(EntityManager em) {
        AppUser appUser = new AppUser().username(UPDATED_USERNAME).password(UPDATED_PASSWORD).email(UPDATED_EMAIL).role(UPDATED_ROLE);
        return appUser;
    }
    ...
    void putExistingAppUser() throws Exception {
        ...
        updatedAppUser.username(UPDATED_USERNAME).password(UPDATED_PASSWORD).email(UPDATED_EMAIL).role(UPDATED_ROLE);
    ...
    void partialUpdateAppUserWithPatch() throws Exception {
        ...
        partialUpdatedAppUser.email(UPDATED_EMAIL).role(UPDATED_ROLE);
    ...
    void fullUpdateAppUserWithPatch() throws Exception {
        ...
        partialUpdatedAppUser.username(UPDATED_USERNAME).password(UPDATED_PASSWORD).email(UPDATED_EMAIL).role(UPDATED_ROLE);
