...
import tech.luau.appsalonmng.repository.ClientRepository;
import tech.luau.appsalonmng.service.dto.ClientDTO;
import tech.luau.appsalonmng.service.mapper.ClientMapper;
...
class ClientResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "2@V.M";
    private static final String UPDATED_EMAIL = "djmK@Gn.?z-";
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.email(UPDATED_EMAIL).phone(UPDATED_PHONE).address(UPDATED_ADDRESS);
