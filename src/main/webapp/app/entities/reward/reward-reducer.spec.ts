...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './reward.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REWARD_LIST actions', async () => {
    ...
    it('dispatches FETCH_REWARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REWARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REWARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REWARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REWARD actions', async () => {
      const expectedActions = [
        {
