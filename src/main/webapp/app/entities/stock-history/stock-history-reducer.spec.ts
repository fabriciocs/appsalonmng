...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STOCKHISTORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_STOCKHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STOCKHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STOCKHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STOCKHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STOCKHISTORY actions', async () => {
      const expectedActions = [
        {
