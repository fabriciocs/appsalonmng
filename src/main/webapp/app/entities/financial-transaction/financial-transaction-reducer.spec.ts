...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './financial-transaction.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches CREATE_FINANCIALTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FINANCIALTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FINANCIALTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FINANCIALTRANSACTION actions', async () => {
      const expectedActions = [
        {
