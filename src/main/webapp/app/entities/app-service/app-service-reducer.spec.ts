...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPSERVICE_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPSERVICE actions', async () => {
      const expectedActions = [
        {
