...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, tech.luau.appsalonmng.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, tech.luau.appsalonmng.repository.UserRepository.USERS_BY_EMAIL_CACHE);
