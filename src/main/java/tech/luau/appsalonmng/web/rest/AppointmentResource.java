...
/**
 * REST controller for managing {@link tech.luau.appsalonmng.domain.Appointment}.
 */
@RestController
...
public class AppointmentResource {
     ...
     */
    @GetMapping("")
    public List<AppointmentDTO> getAllAppointments(@RequestParam(required = false, defaultValue = "true") boolean eagerload) {
