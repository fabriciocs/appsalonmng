...
import tech.luau.appsalonmng.service.ClientService;
import tech.luau.appsalonmng.service.dto.ClientDTO;
import tech.luau.appsalonmng.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link tech.luau.appsalonmng.domain.Client}.
 */
@RestController
...
public class ClientResource {
    ...
    public List<ClientDTO> getAllClients(@RequestParam(required = false) String filter) {
        if ("appuser-is-null".equals(filter)) {
            log.debug("REST request to get all Clients where appUser is null");
            return clientService.findAllWhereAppUserIsNull();
        }
